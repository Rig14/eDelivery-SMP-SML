...
class ServiceMetadataGenerator {
  ...
  fun generateMetadata(partyId: String, receiverUri: URI, receiverCert: String): String {
    val ownCert = loadFile("certs/keystore.crt")
    val metadata = serviceMetadata(partyId, receiverCert, receiverUri)
  ...
  @Language("xml")
  private fun serviceMetadata(party: String, receiverCert: String, receiverUri: URI) = """
    <ServiceMetadata>
      <ServiceInformation>
