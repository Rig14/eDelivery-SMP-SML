...
fun generateMessage(message: String): String {
  ...
  return """
    ...
    <S:Envelope xmlns:S="http://www.w3.org/2003/05/soap-envelope" xmlns:env="http://www.w3.org/2003/05/soap-envelope">
      <S:Header>
        <ns5:Messaging xmlns:ns5="http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/" xmlns:ns3="http://eu.domibus.wsplugin/" xmlns:xmime="http://www.w3.org/2005/05/xmlmime">
          <ns5:UserMessage>
            <ns5:MessageInfo>
