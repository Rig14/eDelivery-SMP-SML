...
class ServiceMetadataGenerator {
  private val apUri = URI("http://ap-receiver:8080/services/msh")
      ...
      <SignedServiceMetadata xmlns="http://docs.oasis-open.org/bdxr/ns/SMP/2016/05">
                      ...
                      <Process>
                          ...
                          <ServiceEndpointList>
                              <Endpoint transportProfile="bdxr-transport-ebms3-as4-v1p0">
                                  <EndpointURI>$apUri</EndpointURI>
                                  <Certificate>
                                      HloYvqEmuxn8Rl8bV4JO9K4b6f9+baUZjuXrrgA+
                                  </Certificate>
                                  <ServiceDescription>This service is used to upload identifiers to the gate
                                  </ServiceDescription>
          ...
          <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
              ...
              <SignatureValue>S8vdN2yINd8UOSVj5uqClDG8qNq0cFNveDehIEWi1W85gkMxhnRRv41yX7dLSP5swLTw7nPxMpl/&#13;
                  ...
                  ts09srub3wDRvA7PFMSZ538GCDeYouoUNd9pEw==
              </SignatureValue>
              <KeyInfo>
                  <X509Data>
