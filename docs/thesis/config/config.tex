...
\newcommand{\thesisTitleEng}{Using eDelivery SML and SMP in eFTI system} % variable with thesis title
\newcommand{\thesisTitleEst}{eDelivery SML ja SMP kasutamine eFTI süsteemis} % Title in Estonian

% Choose your thesis
\newcommand{\thesisType}{Bachelor's Thesis}

% Thesis author
\newcommand{\authorName}{Rihard Rivis}
\newcommand{\studentcode}{222914IAIB}
...
\newcommand{\keywords}{software development, eDelivery, BSc, süsteemianalüüs, Integratsioon, reverse engineering, digiriik, PoC, logistics, legal aspects, hajussüsteem}
...
\ifthenelse{\not \equal{\lang}{ENG}}{
    ...
    \newcommand{\abstactTitle}{Lühikokkuvõte}
