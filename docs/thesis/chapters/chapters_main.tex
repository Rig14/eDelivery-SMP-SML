...
\chapter{eDelivery valmiskomponendid}\label{chapter:method}
\input{chapters/prebuilt-edelivery-components.tex}

\chapter{Näidislahenduse loomine}\label{chapter:result}
\input{chapters/poc-creation.tex}

\chapter{Jõudlustestimine}\label{chapter:discussion}
