...
\chapter{eDelivery valmiskomponendid}\label{chapter:prebuilt-edelivery-components} 
\input{chapters/prebuilt-edelivery-components.tex}

\chapter{Näidislahenduse loomine}\label{chapter:poc-creation} 
\input{chapters/poc-creation.tex}

\chapter{Jõudlustestimine}\label{chapter:performance-testing} 
